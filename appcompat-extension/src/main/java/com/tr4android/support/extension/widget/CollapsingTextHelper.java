...
final class CollapsingTextHelper {
    ...
    private float mExpandedTextOffsetTop;
    private float mCollapsedTextOffsetTop;
    private float mExpandedTextOffsetBottom;
    private float mCollapsedTextOffsetBottom;
    ...
    void setExpandedTextOffsetTop(float offset) {
        if (mExpandedTextOffsetTop != offset) {
            mExpandedTextOffsetTop = offset;
            //recalculate();
        }
    }

    void setCollapsedTextOffsetTop(float offset) {
        if (mCollapsedTextOffsetTop != offset) {
            mCollapsedTextOffsetTop = offset;
            //recalculate();
        }
    }

    void setExpandedTextOffsetBottom(float offset) {
        if (mExpandedTextOffsetBottom != offset) {
            mExpandedTextOffsetBottom = offset;
            //recalculate();
        }
    }

    void setCollapsedTextOffsetBottom(float offset) {
        if (mCollapsedTextOffsetBottom != offset) {
            mCollapsedTextOffsetBottom = offset;
            //recalculate();
        }
    }
        ...
        switch (collapsedAbsGravity & Gravity.VERTICAL_GRAVITY_MASK) {
            ...
            default:
                ...
                mCollapsedDrawY = mCollapsedBounds.centerY() + textOffset
                        - (mCollapsedTextOffsetBottom/2) + (mCollapsedTextOffsetTop/2);
                break;
        }
        ...
        switch (expandedAbsGravity & Gravity.VERTICAL_GRAVITY_MASK) {
            ...
            default:
                ...
                mExpandedDrawY = mExpandedBounds.centerY() + textOffset
                        - (mExpandedTextOffsetBottom/2) + (mExpandedTextOffsetTop/2);
                break;
        }
