 ...
 */
class AppCompatTimePickerDelegate extends AppCompatTimePicker.AbstractTimePickerDelegate implements
        ...
        switch (pickerIndex) {
            case HOUR_INDEX:
                if (mAllowAutoAdvance && autoAdvance) {
                    ...
                    ViewCompatUtils.announceForAccessibility(mDelegator, newValue + ". " + mSelectMinutes);
                } else {
    ...
    private void tryAnnounceForAccessibility(CharSequence text, boolean isHour) {
        if (mLastAnnouncedIsHour != isHour || !text.equals(mLastAnnouncedText)) {
            ...
            ViewCompatUtils.announceForAccessibility(mDelegator, text);
    ...
    private void setCurrentItemShowing(int index, boolean animateCircle, boolean announce) {
        ...
        if (index == HOUR_INDEX) {
            if (announce) {
                ViewCompatUtils.announceForAccessibility(mDelegator, mSelectHours);
            }
        } else {
            if (announce) {
                ViewCompatUtils.announceForAccessibility(mDelegator, mSelectMinutes);
            }
        }
    ...
    private boolean addKeyIfLegal(int keyCode) {
        ...
        ViewCompatUtils.announceForAccessibility(mDelegator, String.format("%d", val));
    ...
    private final View.OnClickListener mClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            } else {// Failed to handle this click, don't vibrate.
                return;
            }
